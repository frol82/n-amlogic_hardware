...
WLAN_REQ_ENTRY arWlanOidReqTable[] = {
	...
	{OID_CUSTOM_SLT, DISP_STRING("OID_CUSTOM_SLT"), FALSE, FALSE, ENUM_OID_DRIVER_CORE,
	 sizeof(PARAM_MTK_SLT_TEST_STRUCT_T), wlanoidQuerySLTStatus, wlanoidUpdateSLTMode}
	,
#endif
	...
	{OID_CUSTOM_MCR_RW, DISP_STRING("OID_CUSTOM_MCR_RW"), TRUE, TRUE, ENUM_OID_DRIVER_CORE,
	 sizeof(PARAM_CUSTOM_MCR_RW_STRUCT_T), wlanoidQueryMcrRead, wlanoidSetMcrWrite}
	,
	{OID_CUSTOM_EEPROM_RW, DISP_STRING("OID_CUSTOM_EEPROM_RW"), TRUE, TRUE,
	 ENUM_OID_DRIVER_CORE, sizeof(PARAM_CUSTOM_EEPROM_RW_STRUCT_T), wlanoidQueryEepromRead,
	 wlanoidSetEepromWrite}
	,
	{OID_CUSTOM_SW_CTRL, DISP_STRING("OID_CUSTOM_SW_CTRL"), TRUE, TRUE, ENUM_OID_DRIVER_CORE,
	 sizeof(PARAM_CUSTOM_SW_CTRL_STRUCT_T), wlanoidQuerySwCtrlRead, wlanoidSetSwCtrlWrite}
	,
	...
	{OID_CUSTOM_MTK_WIFI_TEST, DISP_STRING("OID_CUSTOM_MTK_WIFI_TEST"), TRUE, TRUE,
	 ENUM_OID_DRIVER_CORE, sizeof(PARAM_MTK_WIFI_TEST_STRUCT_T), wlanoidRftestQueryAutoTest,
 ...
 * TRUE,   FALSE,  ENUM_OID_DRIVER_CORE,  sizeof(PARAM_CUSTOM_RFTEST_RX_STATUS_STRUCT_T),
 * wlanoidQueryRfTestRxStatus,    NULL }, */
/* { OID_CUSTOM_TEST_TX_STATUS, DISP_STRING("OID_CUSTOM_TEST_TX_STATUS"),
 * TRUE,   FALSE,  ENUM_OID_DRIVER_CORE,  sizeof(PARAM_CUSTOM_RFTEST_TX_STATUS_STRUCT_T),
